This directory contains the coding sample for the application to the Research Fellow position at RegLab. The main dofile, union_premium.do, uses as input the data file
